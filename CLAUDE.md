...
- What ships next after the persistence work -- a business-facing dashboard (bookings, feedback, customer interactions in one place) vs. Phase 1 voice vs. something else -- both were discussed but no priority between them was decided; don't start either without checking
